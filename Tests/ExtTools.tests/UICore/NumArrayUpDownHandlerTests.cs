...
{
  [TestFixture]
  class NumArrayUpDownHandlerTests
  {
    #region Конструкторы
    ...
    public void Constructor_Array_NoSort()
    {
      ...
      NumArrayUpDownHandler<int> sut = new NumArrayUpDownHandler<int>(a, false);
    ...
    public void Constructor_Array_Sort()
    {
      ...
      NumArrayUpDownHandler<int> sut = new NumArrayUpDownHandler<int>(a, true);
    ...
    public void Constructor_Array_Comparer()
    {
      ...
      NumArrayUpDownHandler<int> sut = new NumArrayUpDownHandler<int>(a, true, comparer);
    ...
    public void Constructor_Enumarable()
    {
      ...
      lst.Add(10);
      lst.Add(1);
      NumArrayUpDownHandler<int> sut = new NumArrayUpDownHandler<int>(lst);
    ...
    public void Constructor_Enumarable_Comparer()
    {
      ...
      lst.Add(1);
      ReverseComparer comparer = new ReverseComparer();
      NumArrayUpDownHandler<int> sut = new NumArrayUpDownHandler<int>(lst, comparer);
    ...
    public void GetUpDown_float(float? current, float? wantedPrev, float? wantedNext)
    {
      ...
      NumArrayUpDownHandler<float> sut = new NumArrayUpDownHandler<float>(a, false);
    ...
    public void GetUpDown_userType(int? current, int? wantedPrev, int? wantedNext)
    {
      ...
      NumArrayUpDownHandler<TestType> sut = new NumArrayUpDownHandler<TestType>(a, false, comparer);
