...
namespace ExtTools_tests.Core
{
  ...
  class MathToolsTests
  {
    ...
    {
      Assert.AreEqual(wanted, MathTools.IsIntegerType(t));
    }
    ...
    {
      Assert.AreEqual(wanted, MathTools.IsFloatType(t));
    }
    ...
    {
      Assert.AreEqual(wanted, MathTools.IsNumericType(t));
    }
    ...
    {
      int res1 = MathTools.CompareNumbers(info.A, info.B);
      Assert.AreEqual(info.WantedRes, Math.Sign(res1), "#1");

      int res2 = MathTools.CompareNumbers(info.B, info.A);
    ...
    {
      double res1 = MathTools.Round(value, decimals);
      double delta = Math.Abs(wantedRes) / 1000.0;
      Assert.AreEqual(wantedRes, res1, delta, "Double");

      decimal res2 = MathTools.Round((decimal)value, decimals);
    ...
    {
      double res1 = MathTools.Floor(value, decimals);
      double delta = Math.Abs(wantedRes) / 1000.0;
      Assert.AreEqual(wantedRes, res1, delta, "Double");

      decimal res2 = MathTools.Floor((decimal)value, decimals);
      Assert.AreEqual((decimal)wantedRes, res2, "Decimal");
    }
    ...
    {
      double res1 = MathTools.Ceiling(value, decimals);
      double delta = Math.Abs(wantedRes) / 1000.0;
      Assert.AreEqual(wantedRes, res1, delta, "Double");

      decimal res2 = MathTools.Ceiling((decimal)value, decimals);
      Assert.AreEqual((decimal)wantedRes, res2, "Decimal");
    }
    ...
    {
      double res1 = MathTools.Truncate(value, decimals);
      double delta = Math.Abs(wantedRes) / 1000.0;
      Assert.AreEqual(wantedRes, res1, delta, "Double");

      decimal res2 = MathTools.Truncate((decimal)value, decimals);
      Assert.AreEqual((decimal)wantedRes, res2, "Decimal");
    }
    ...
    {
      return MathTools.DivideWithRounding(x, y);
    }
    ...
    public void DivideWithRounding_int_divide_by_zero()
    {
      ...
      { MathTools.DivideWithRounding(1, 0); });
    }
    ...
    {
      Assert.Throws(typeof(DivideByZeroException), delegate ()
      { MathTools.DivideWithRounding(1L, 0L); });
    }
    ...
    public void SumValues(object a, object b, object wanted)
    {
      ...
      object res = MathTools.SumValues(a, b);
    ...
    public void SubstractValues(object a, object b, object wanted)
    {
      ...
      object res = MathTools.SubstractValues(a, b);
      Assert.AreEqual(wanted, res);
    }
    ...
    public void NegValue(object a, object wanted)
    {
      ...
      object res = MathTools.NegValue(a);
      Assert.AreEqual(wanted, res);
    }
    ...
    public void MultiplyValues(object a, object b, object wanted)
    {
      ...
      object res = MathTools.MultiplyValues(a, b);
      Assert.AreEqual(wanted, res);
    }
    ...
    public void DivideValues(object a, object b, object wanted)
    {
      ...
      object res = MathTools.DivideValues(a, b);
      Assert.AreEqual(wanted, res);
    }
    ...
    public void AbsValue(object a, object wanted)
    {
      ...
      object res = MathTools.AbsValue(a);
      Assert.AreEqual(wanted, res);
    }
    ...
    {
      bool res = MathTools.IsInRange<int>(testValue, firstValue, lastValue);
      Assert.AreEqual(wanted, res);
    }
    ...
    {
      bool res = MathTools.IsInRange<float>(testValue, firstValue, lastValue);
      Assert.AreEqual(wanted, res);
    }
    ...
    {
      bool res1 = MathTools.AreRangesCrossed<float>(firstValue1, lastValue1, firstValue2, lastValue2);
      Assert.AreEqual(wantedRes, res1, "AreRangesCrossed() #1 result");

      bool res2 = MathTools.AreRangesCrossed<float>(firstValue2, lastValue2, firstValue1, lastValue1);
      Assert.AreEqual(wantedRes, res2, "AreRangesCrossed() #2 result");

      float? firstCross3 = firstValue1;
      float? lastCross3 = lastValue1;
      bool res3 = MathTools.GetRangeCross<float>(ref firstCross3, ref lastCross3, firstValue2, lastValue2);
      ...
      bool res4 = MathTools.GetRangeCross<float>(ref firstCross4, ref lastCross4, firstValue1, lastValue1);
      ...
      float? wantedFirstUnion, float? wantedLastUnion)
    {
      ...
      MathTools.GetRangeUnion<float>(ref firstUnion1, ref lastUnion1, firstValue2, lastValue2);
      ...
      MathTools.GetRangeUnion<float>(ref firstUnion2, ref lastUnion2, firstValue1, lastValue1);
