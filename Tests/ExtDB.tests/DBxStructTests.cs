  ...
  public class DBxStructTests:FixtureWithSetUp
  {
    ...
    public void Constructor_DBxCon()
    {
      using (SQLiteDBx db = new SQLiteDBx())
      {
        ...
        {
          DBxStruct sut = new DBxStruct(con);
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      Assert.DoesNotThrow(delegate () { sut.CheckStruct(_CheckStructDB); });
    }
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      DBxTableStruct ts = sut.Tables.Add("===");
      ts.Columns.AddId();
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(_CheckStructDB); });
    }
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      DBxTableStruct ts = sut.Tables.Add("XXX");
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(_CheckStructDB); });
    }
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      DBxTableStruct ts = sut.Tables.GetRequired("Test1");
    ...
    public void CheckStruct_zeroStringLength()
    {
      ...
      cs.MaxLength = 0;
      ts.Columns.Add(cs);
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(null); });
    }
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      sut.Tables["Test2"].Columns.AddReference("RR", "T666");
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(null); });
    }
    ...
    public void CheckStruct_refCol_invalidColumnType()
    {
      ...
      sut.Tables["Test2"].Columns.Add(cs);
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(null); });
    }
    ...
    {
      DBxStruct sut = CreateTestObject(false);
      sut.Tables["Test1"].PrimaryKey = DBxColumns.Empty;
      sut.Tables["Test2"].Columns.AddReference("RR", "Test1");
      Assert.Catch<DBxStructException>(delegate () { sut.CheckStruct(null); });
    }
