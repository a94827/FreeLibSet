...
namespace ExtDB_tests.Data
{
  ...
  public class OrFilterTests
  {
    ...
    public void Constructor_Array()
    {
      ...
      OrFilter sut = new OrFilter(filters);
    ...
    public void Constructor_2args_simple()
    {
      ...
      OrFilter sut = new OrFilter(f1, f2);
      CollectionAssert.AreEqual(new DBxFilter[2] { f1, f2}, sut.Filters, "Filters");
      Assert.AreEqual(DBxFilterDegeneration.None, sut.Degeneration, "Degeneration");
    }

    [Test]
    public void Constructor_2args_OR_Other()
    {
      DBxFilter f1 = new ValueFilter("F1", 111);
      DBxFilter f2 = new ValueFilter("F2", 222);
      DBxFilter f3 = new ValueFilter("F3", 333);
      DBxFilter f12 = new OrFilter(f1, f2);

      OrFilter sut = new OrFilter(f12, f3);
      CollectionAssert.AreEqual(new DBxFilter[3] { f1, f2, f3 }, sut.Filters, "Filters");
      Assert.AreEqual(DBxFilterDegeneration.None, sut.Degeneration, "Degeneration");
    }

    [Test]
    public void Constructor_2args_Other_OR()
    {
      DBxFilter f1 = new ValueFilter("F1", 111);
      DBxFilter f2 = new ValueFilter("F2", 222);
      DBxFilter f3 = new ValueFilter("F3", 333);
      DBxFilter f23 = new OrFilter(f2, f3);

      OrFilter sut = new OrFilter(f1, f23);
      CollectionAssert.AreEqual(new DBxFilter[3] { f1, f2, f3 }, sut.Filters, "Filters");
      Assert.AreEqual(DBxFilterDegeneration.None, sut.Degeneration, "Degeneration");
    }

    [Test]
    public void Constructor_2args_OR_OR()
    {
      DBxFilter f1 = new ValueFilter("F1", 111);
      DBxFilter f2 = new ValueFilter("F2", 222);
      DBxFilter f3 = new ValueFilter("F3", 333);
      ...
      DBxFilter f12 = new OrFilter(f1, f2);
      DBxFilter f34 = new OrFilter(f3, f4);

      OrFilter sut = new OrFilter(f12, f34);
    ...
    {
      Assert.Catch<ArgumentNullException>(delegate () { new OrFilter((DBxFilter[])null); }, "null");
      Assert.Catch<ArgumentException>(delegate () { new OrFilter((new DBxFilter[0])); }, "Length=0");
      DBxFilter f1 = new ValueFilter("F1", 123);
      Assert.Catch<ArgumentException>(delegate () { new OrFilter((new DBxFilter[1] { f1 })); }, "Length=1");

      Assert.Catch<ArgumentNullException>(delegate () { new OrFilter(f1, null); }, "First is null");
      Assert.Catch<ArgumentNullException>(delegate () { new OrFilter(null, f1); }, "Second is null");
    }
    ...
    public void FromList_FromArray_3_normal()
    {
      ...
      DoTestOrFilter(OrFilter.FromList(filters), "FromList()", filters[0], filters[1], filters[2]);
      DoTestOrFilter(OrFilter.FromArray(filters.ToArray()), "FromArray()", filters[0], filters[1], filters[2]);
    }
    ...
    public void FromList_FromArray_2_normal()
    {
      ...
      DoTestOrFilter(OrFilter.FromList(filters), "FromList()", filters[0], filters[1] );
      DoTestOrFilter(OrFilter.FromArray(filters.ToArray()), "FromArray()", filters[0], filters[1]);
    }
    ...
    public void FromList_FromArray_1_normal()
    {
      ...
      DBxFilter res1 = OrFilter.FromList(filters);
      Assert.AreSame(filters[0], res1, "FromList()");

      DBxFilter res2 = OrFilter.FromArray(filters.ToArray());
    ...
    public void FromList_FromArray_0_normal()
    {
      ...
      DBxFilter res1 = OrFilter.FromList(filters);
      DoTestDummyFilterFalse(res1, "FromList()");

      DBxFilter res2 = OrFilter.FromArray(filters.ToArray());
      DoTestDummyFilterFalse(res2, "FromArray()");
    }
    ...
    public void FromList_FromArray_null()
    {
      ...
      DBxFilter res1 = OrFilter.FromList(filters1);
      DoTestDummyFilterFalse(res1, "FromList()");

      DBxFilter[] filters2 = null;
      DBxFilter res2 = OrFilter.FromArray(filters2);
      DoTestDummyFilterFalse(res2, "FromArray()");
    }
    ...
    public void FromList_FromArray_1_True()
    {
      ...
      Assert.IsNull(OrFilter.FromList(filters), "FromList()");
      Assert.IsNull(OrFilter.FromArray(filters.ToArray()), "FromArray()");
    }
    ...
    public void FromList_FromArray_1_False()
    {
      ...
      DoTestDummyFilterFalse(OrFilter.FromList(filters), "FromList()");
      DoTestDummyFilterFalse(OrFilter.FromArray(filters.ToArray()), "FromArray()");
    }
    ...
    public void FromList_FromArray_2_True_X()
    {
      ...
      //DoTestDummyFilterTrue(OrFilter.FromList(filters), "FromList()");
      //DoTestDummyFilterTrue(OrFilter.FromArray(filters.ToArray()), "FromArray()");
      Assert.IsNull(OrFilter.FromList(filters), "FromList()");
      Assert.IsNull(OrFilter.FromArray(filters.ToArray()), "FromArray()");
    }
    ...
    public void FromList_FromArray_3_X_False_X()
    {
      ...
      DoTestOrFilter(OrFilter.FromList(filters), "FromList()", filters[0], filters[2]);
      DoTestOrFilter(OrFilter.FromArray(filters.ToArray()), "FromArray()", filters[0], filters[2]);
    }
    ...
    private static void DoTestOrFilter(DBxFilter res, string messagePrefix, params DBxFilter[] wantedFilters)
    {
      Assert.IsInstanceOf<OrFilter>(res, messagePrefix + "-Type");
    ...
    //private static void DoTestDummyFilterTrue(DBxFilter res, string messagePrefix)
    //{
    ...
    [TestCase(true, null, null, DBxFilterDegeneration.AlwaysTrue)]
    [TestCase(null, true, null, DBxFilterDegeneration.AlwaysTrue)]
    [TestCase(null, null, true, DBxFilterDegeneration.AlwaysTrue)]
    [TestCase(null, true, false, DBxFilterDegeneration.AlwaysTrue)]
    [TestCase(null, false, false, DBxFilterDegeneration.None)]
    [TestCase(false, false, false, DBxFilterDegeneration.AlwaysFalse)]
    ...
    {
      DBxFilter[] filters = new DBxFilter[3];
      filters[0] = new DummyFilter(false);
      filters[1] = new DummyFilter(false);
    ...
    public void Serialization()
    {
      ...
      OrFilter res = (OrFilter)(SerializationTools.DeserializeBinary(b));
