...
namespace ExtDB.tests
{
  ...
  public class DBxTableColumnListTests
  {
    ...
    public void Tables_Add()
    {
      ...
      sut.Tables["Tab2"].Add("F8,F9"); // друга€ таблица
    ...
    public void Tables_Remove()
    {
      ...
      sut.Tables["Tab2"].Add("F3,F4"); // друга€ таблица
    ...
    public void IsReadOnly_exceptions()
    {
      ...
      Assert.Throws<ObjectReadOnlyException>(delegate() { sut[new DBxTableColumnName("Tab1", "F1")] = false; }); // действи€ дл€ true и false могут выполн€тьс€ по разному

      Assert.Throws<ObjectReadOnlyException>(delegate() { sut["Tab1", "F1"] = true; });
      Assert.Throws<ObjectReadOnlyException>(delegate() { sut["Tab1", "F1"] = false; }); // действи€ дл€ true и false могут выполн€тьс€ по разному
    }
    ...
    public void Pairs_CopyTo()
    {
      ...
      // ѕор€док элементов €вл€етс€ предопределенным
