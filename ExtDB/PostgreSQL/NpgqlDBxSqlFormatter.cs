...
namespace FreeLibSet.Data.Npgsql
{
  ...
  public class NpgsqlDBxSqlFormatter : BaseDBxSqlFormatter
  {
    ...
    /// <returns></returns>
    protected override bool AreParenthesesRequired(DBxExpression expression)
    {
      ...
      return base.AreParenthesesRequired(expression);
    }
    ...
    protected override void FormatOrder(DBxSqlBuffer buffer, DBxOrder order)
    {
