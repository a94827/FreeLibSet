...
{
  /// <summary>
  /// Математические функции, не связанные с наборами данных
  /// </summary>
  public static class MathTools
  {
    ...
    #region Типы данных для выполнения математических операций

    /// <summary>
    /// Типы для суммирования.
    /// В перечислении они располагаются в порядке "возрастания" типа
    /// </summary>
    internal enum SumType { None, Int32, Int64, Single, Double, Decimal, DateTime, TimeSpan };
    ...
    private static Dictionary<Type, SumType> CreateSumTypeDict()
    {
      ...
      Dict.Add(typeof(Byte), SumType.Int32);
      Dict.Add(typeof(SByte), SumType.Int32);
      Dict.Add(typeof(Int16), SumType.Int32);
      Dict.Add(typeof(UInt16), SumType.Int32);
      Dict.Add(typeof(Int32), SumType.Int32);
      Dict.Add(typeof(UInt32), SumType.Int32);
    ...
    internal static SumType GetSumType(Type typ)
    {
#if DEBUG
      if (typ == null)
    ...
    internal static object ConvertValue(object v, SumType st)
    {
      switch (st)
      {
        case SumType.Int32: return DataTools.GetInt32(v);
    ...
    /// <returns></returns>
    internal static SumType GetLargestSumType(SumType st1, SumType st2)
    {
      if (st1 == st2)
        return st1;
      if (st1 == SumType.None)
    ...
    public static object SumValues(object a, object b)
    {
      ...
      checked
      {
        switch (st)
        {
          case SumType.Int32: return (int)v1 + (int)v2;
    ...
    public static object NegValue(object a)
    {
      ...
      checked
      {
        switch (st)
        {
          case SumType.Int32: return -(int)v;
    ...
    public static object AbsValue(object a)
    {
      ...
      checked
      {
        switch (st)
        {
          case SumType.Int32: return Math.Abs((int)v);
