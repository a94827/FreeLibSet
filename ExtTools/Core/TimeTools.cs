...
{
  /// <summary>
  /// Функции работы с <see cref="DateTime"/> и TimeSpan.
  /// Функции, имеющие в имени "Date" отбрасывают компонент времени
  /// </summary>
    ...
    public static DateTime SetDateDay(DateTime dt, int day)
    {
