...
{
  #region Перечисление DBxFilterDegeneration
  ...
  public class ValuesFilter : DBxOneExpressionFilter
  {
    ...
    public override bool TestFilter(INamedValuesAccess rowValues)
    {
      ...
      return TestFilter(v, Values, this.ColumnType);
    }

    internal static bool TestFilter(object v, Array values, DBxColumnType colType)
    {
...
/// <summary>
  ...
  public class StringValueFilter : DBxOneExpressionFilter
  {
    ...
    /// Пустая строка является допустимым значением фильтра, при этом поле может принимать значение NULL или "".
    /// </summary>
