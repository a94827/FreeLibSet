...
namespace TwainLib
{
  ...
  // Нельзя наследовать из DisposableObject, т.к. размер структуры является фиксированным
