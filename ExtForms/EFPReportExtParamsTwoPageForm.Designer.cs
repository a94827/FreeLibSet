namespace AgeyevAV.ExtForms
{
  partial class EFPReportExtParamsTwoPageForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.FiltersTabPage.Text = "‘ильтры";
    ...
    /// <summary>
    /// ¬кладка "ќбщие".
    /// —юда должны быть добавлены пользовательские управл€ющие элементы, задающие основные параметры отчета
    /// </summary>
