    ...
    private void SetDropPosition(Point pt)
    {
      ...
      if (node != null)
      {
        ...
        if (pos < TopEdgeSensivity)
          _dropPosition.Position = TreeViewAdvNodePosition.Before;
        else if (pos > (1 - BottomEdgeSensivity))
          _dropPosition.Position = TreeViewAdvNodePosition.After;
        else
          _dropPosition.Position = TreeViewAdvNodePosition.Inside;
      }
    }
