...
namespace FreeLibSet.Forms.Data
{
  ...
  /// </summary>
  public class ExtValueCheckBox : ExtValueControl<bool, EFPCheckBox>
  {
    #region Конструктор
    ...
    public ExtValueCheckBox(DBxExtValue extValue, EFPCheckBox controlProvider, bool canMultiEdit)
      : base(extValue, controlProvider, false, canMultiEdit)
    {
      ...
      controlProvider.CanBeEmpty = extValue.Grayed;
      if (extValue.Grayed)
  ...
  public abstract class ExtValueCheckBoxWithControl<TValue, TControlProvider> : ExtValueControlBase2<TValue>
    where TControlProvider : EFPControlBase
  {
    ...
    /// Создает переходник
    /// </summary>
    /// <param name="extValue">Редактируемое значение</param>
    ...
    public ExtValueCheckBoxWithControl(DBxExtValue extValue, EFPCheckBox controlProvider1, TControlProvider controlProvider2, bool canMultiEdit)
      : base(extValue, controlProvider1, false, canMultiEdit)
    {
      ...
      controlProvider1.CanBeEmpty = extValue.Grayed;
