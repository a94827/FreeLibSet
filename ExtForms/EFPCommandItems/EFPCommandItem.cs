...
namespace FreeLibSet.Forms
{
  ...
  public class EFPCommandItem : IObjectWithCode, ICloneable
  {
    ...
    /// Обработчик может инициализировать доступность (<see cref="Enabled"/>) и другие свойства команды меню.
    /// Вызов обработчика не зависит от текущей видимости и других свойств команды.
    /// </summary>
