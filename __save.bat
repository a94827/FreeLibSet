...
7za.exe a -r -x!Others\*.* -x!TemporaryGeneratedFile_*.* FreeLibSetSrc.7z *.sln *.cs *.resx *.csproj *.user *.bmp *.png *.cur *._gif *.ico *.bat app.config *.htm *.nunit ExtDB\TemplateFiles\*.*
