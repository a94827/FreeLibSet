...
namespace FreeLibSet.Forms.Docs
{
  ...
  /// <summary>
  /// Провайдер комбоблока, который предназначен для показа таблицы <see cref="EFPSubDocGridView"/> в редакторе документа.
  ...
  public class EFPAllSubDocComboBox : EFPUserSelComboBox
  {
    ...
    /// вызывается <see cref="DocumentEditor.ValidateData()"/> для <see cref="MainEditor"/>. В этом случае редактор поддокумента
