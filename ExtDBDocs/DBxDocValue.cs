...
namespace FreeLibSet.Data.Docs
{
  ...
  public struct DBxDocValue : IReadOnlyObject, IObjectWithCode
  {
    ...
    /// <summary>
    /// Получение двоичных данных для ссылочного поля, объявленного в BinDataRefs, и преобразование в XML-документ.
    ...
    /// <summary>
    /// Запись XML-документа в ссылочное поля, объявленное в BinDataRefs.
    /// Присвоение значения null очищает ссылочное поле.
